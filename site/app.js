...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bd, request.ac, true);
		} catch (e) {
...
var $author$project$Main$Exclude = 1;
var $author$project$Main$Loading = {$: 0};
var $author$project$Main$Require = 0;
...
var $author$project$Main$Change = F5(
	function (date, weekday, tags, text, url) {
		return {R: date, H: tags, ab: text, ac: url, aX: weekday};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a0: false, a2: r.a2, a7: r.a7, ao: r.ao, bd: r.bd, bo: r.bo, aS: r.aS, ac: r.ac}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{a2: $elm$http$Http$emptyBody, a7: r.a7, ao: _List_Nil, bd: 'GET', bo: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, ac: r.ac});
};
var $author$project$Main$loadChanges = function (patch) {
...
var $author$project$Main$init = function (args) {
	...
	return _Utils_Tuple2(
		...
		$author$project$Main$loadChanges(args.p));
};
...
var $author$project$Main$filtersChanged = _Platform_outgoingPort(
	'filtersChanged',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'excludeTags',
					$elm$json$Json$Encode$list($elm$json$Json$Encode$string)($.K)),
					_Utils_Tuple2(
					'includeTags',
					$elm$json$Json$Encode$list($elm$json$Json$Encode$string)($.L)),
					_Utils_Tuple2(
					'patch',
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var sendFiltersChanged = function (_v6) {
			var newModel = _v6.a;
			var cmd = _v6.b;
			return _Utils_Tuple2(
				newModel,
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							cmd,
							$author$project$Main$filtersChanged(
							{
								K: $elm$core$Dict$keys(
									A2(
		...
		switch (msg.$) {
			...
			case 1:
				var result = msg.a;
				if (!result.$) {
					var changes = result.a;
					var tagSet = A3(
						$elm$core$List$foldl,
						F2(
							function (c, s) {
								return A2($elm$core$Set$union, s, c.H);
							}),
						$elm$core$Set$empty,
						changes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								D: $author$project$Main$Changes(changes),
								n: A2(
									$elm$core$Dict$filter,
									F2(
										function (tag, _v2) {
											return A2($elm$core$Set$member, tag, tagSet);
										}),
									model.n),
								aa: tagSet
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								D: $author$project$Main$Error(err)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 2:
				var patch = msg.a;
				return sendFiltersChanged(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{D: $author$project$Main$Loading, p: patch}),
						$author$project$Main$loadChanges(patch)));
			case 3:
				var term = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{k: term}),
					A2(
						$author$project$Main$setTimeout,
						100,
						$author$project$Main$SendFiltersChanged(term)));
			case 4:
				var ifTerm = msg.a;
				return _Utils_eq(model.k, ifTerm) ? sendFiltersChanged(
			...
			case 5:
				...
				var newFilters = function () {
					if (state === 2) {
						return A2($elm$core$Dict$remove, tag, filters);
					} else {
						return A3($elm$core$Dict$insert, tag, state, filters);
					}
				}();
				return sendFiltersChanged(
					_Utils_Tuple2(
...
var $author$project$Main$IncreasePageSize = {$: 6};
...
var $author$project$Main$Ignore = 2;
...
var $author$project$Main$tagFilterState = F2(
	function (model, tag) {
		return A2(
			$elm$core$Maybe$withDefault,
			2,
			A2($elm$core$Dict$get, tag, model.n));
	});
var $elm$html$Html$Attributes$title = $elm$html$Html$Attributes$stringProperty('title');
var $author$project$Main$viewTagSwitch = F2(
	function (model, tag) {
		var enabled = !A2($author$project$Main$tagFilterState, model, tag);
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$SetTagFilter, tag, 2))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('×')
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SetTagFilter, tag, 0))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('+')
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SetTagFilter, tag, 1))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('−')
...
var $author$project$Main$viewChange = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						$author$project$Main$viewTagSwitch(model),
						$elm$core$Set$toList(change.H))),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href(change.ac)
								]),
							_List_fromArray(
								[
...
var $author$project$Main$viewChanges = F2(
	function (model, changes) {
		var viewChangeSet = function (_v0) {
			var _v1 = _v0.a;
			var date = _v1.a;
			var weekday = _v1.b;
			var changeSet = _v0.b;
			return A2(
				...
				A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$Main$viewChange(model),
						changeSet)));
		};
		var groupByDate = F2(
			function (change, dict) {
				var key = _Utils_Tuple2(change.R, change.aX);
				var list = A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
				...
				return A3(
					...
					key,
					A2($elm$core$List$cons, change, list),
					dict);
			});
		...
		return (!$elm$core$Dict$size(byDate)) ? _Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('changes')
					]),
				A2(
					$elm$core$List$map,
					viewChangeSet,
					A2(
						...
						$elm$core$List$reverse(
							$elm$core$Dict$toList(byDate))))),
			_Utils_cmp(
				$elm$core$Dict$size(byDate),
				model.F) > 0);
	});
var $author$project$Main$SetSearchTerm = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$SetPatch = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$viewPatchSelect = function (model) {
	var opt = function (_v0) {
		var val = _v0.a;
		var txt = _v0.b;
		return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Events$onInput($author$project$Main$SetPatch)
			]),
		A2(
			$elm$core$List$map,
			opt,
...
var $author$project$Main$viewFilters = function (model) {
	var tagPill = function (t) {
		var _v0 = function () {
			var _v1 = A2($elm$core$Dict$get, t, model.n);
			_v1$2:
			while (true) {
				if (!_v1.$) {
					switch (_v1.a) {
						case 0:
							var _v2 = _v1.a;
							return _Utils_Tuple3('−', 1, 'plus');
						case 1:
							var _v3 = _v1.a;
							return _Utils_Tuple3('+', 0, 'minus');
						default:
							break _v1$2;
					}
				} else {
			...
			return _Utils_Tuple3('', 2, '');
		}();
		var prefix = _v0.a;
		var invertedValue = _v0.b;
		var extraClass = _v0.c;
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('pill ' + extraClass)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$title('invert filter'),
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SetTagFilter, t, invertedValue))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$title('remove filter'),
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SetTagFilter, t, 2))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('×')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewPatchSelect(model),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Main$SetSearchTerm),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('active-tag-filters')
					]),
				A2(
					$elm$core$List$map,
					tagPill,
...
var $author$project$Main$visibleChanges = F2(
	function (model, changes) {
		var searchQuery = A2(
			$elm$core$List$map,
			$elm$core$String$toLower,
			$elm$core$String$words(model.k));
		var matchesSearchTerm = function (change) {
			if (model.k === '') {
				return true;
			} else {
				var doc = A2(
				...
				var runQuery = function (terms) {
					...
					while (true) {
						...
						if (_v4.$ === 1) {
							return _Utils_Tuple2(_List_Nil, true);
						} else {
							var term = _v4.a;
							if (A2(
								$elm$core$List$any,
								function (text) {
									return A2($elm$core$String$contains, term, text);
								},
								doc)) {
								var $temp$terms = A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									$elm$core$List$tail(terms));
								terms = $temp$terms;
								continue runQuery;
							} else {
		...
		var matchesTags = function (change) {
			return ($elm$core$Set$size(
				A2($elm$core$Set$intersect, change.H, excluded)) > 0) ? false : (_Utils_cmp(
				$elm$core$Set$size(
					A2($elm$core$Set$intersect, change.H, required)),
				$elm$core$Set$size(required)) > -1);
		};
		var isIncluded = function (change) {
			return matchesTags(change) && matchesSearchTerm(change);
		};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('No changes have been published for the selected season.')
											]))
									]))
							]);
					} else {
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{bb: $author$project$Main$init, bn: $author$project$Main$subscriptions, bq: $author$project$Main$update, br: $author$project$Main$view});
	...
	A2(
		...
		function (searchTerm) {
			return A2(
							...
							return A2(
								...
								function (excludeTags) {
									return $elm$json$Json$Decode$succeed(
										{K: excludeTags, L: includeTags, p: patch, k: searchTerm});
								},
								A2(
									$elm$json$Json$Decode$field,
									'excludeTags',
				...
				A2($elm$json$Json$Decode$field, 'patch', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'searchTerm', $elm$json$Json$Decode$string)))(0)}});}(this));